...
public class TreeMapRunner {
    public static void main(String[] args) {
        ...
        //найдем у кого больше 80
        AverageStudentGrade border = grades.ceilingKey(new AverageStudentGrade("", 80));//возвращает самый маленький из больших
